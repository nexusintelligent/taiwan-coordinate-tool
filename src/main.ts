...
app.innerHTML = `
  ...
  <main class="app-shell">
    ...
    <section class="map-workspace">
      <button id="toggleMenuBar" class="menu-toggle" title="顯示或隱藏功能列">☷</button><nav class="desktop-menu" aria-label="圖資功能選單">
        ...
        <div class="desktop-menu-group"><button class="desktop-menu-trigger" aria-expanded="false">檢視</button><div class="desktop-submenu"><button data-menu-action="fit">縮放至全部圖徵</button><button data-menu-action="toggle-workbench">顯示／隱藏左側工作區</button><button data-menu-action="theme">切換深淺色主題</button></div></div>
